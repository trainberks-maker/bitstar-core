...
def public_accounting(accounting):
    ...
    return {
        ...
        "dry_run_ledger_database": bool(accounting.get("dry_run_ledger_database")),
        "dry_run_ledger_json_mirror": bool(accounting.get("dry_run_ledger_json_mirror")),
        "dry_run_ledger_backup_required": bool(accounting.get("dry_run_ledger_backup_required")),
...
def public_dry_run_ledger(ledger):
    ...
    return {
        ...
        "database_backed": bool(ledger.get("database_backed")),
        "json_mirror": bool(ledger.get("json_mirror")),
        "backup_required": bool(ledger.get("backup_required")),
