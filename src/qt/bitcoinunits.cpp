...
{
    switch (unit) {
    case Unit::BTC: return QString("BST");
    case Unit::mBTC: return QString("mBST");
    case Unit::uBTC: return QString::fromUtf8("µBST (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("BitStars");
    case Unit::mBTC: return QString("Milli-BitStars (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-BitStars (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
