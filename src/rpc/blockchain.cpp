...
static RPCMethod waitfornewblock()
{
    return RPCMethod{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (bitstar-cli -rpcclienttimeout=0)",
                {
...
static RPCMethod scanblocks()
{
    return RPCMethod{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (bitstar-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCMethod getdescriptoractivity()
{
    return RPCMethod{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (bitstar-cli -rpcclienttimeout=0)",
        {
...
static RPCMethod dumptxoutset()
{
    return RPCMethod{
        ...
        "For deep rollbacks, make sure to use no RPC timeout (bitstar-cli -rpcclienttimeout=0) as it may take several minutes.",
        {
...
static RPCMethod loadtxoutset()
{
    return RPCMethod{
        ...
        "The result is a usable bitstard instance that is current with the network tip in a "
