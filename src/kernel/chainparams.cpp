...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        const char* bitstar_genesis_msg = "BitStar 21/Aug/2026 fair launch - no premine - 21 million BST";
        const CScript bitstar_genesis_script = CScript() << "04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f"_hex << OP_CHECKSIG;
        genesis = CreateGenesisBlock(bitstar_genesis_msg, bitstar_genesis_script, 1787270400, 1415949, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000c45c905ce3e3beeb9eb534650276947373d3a2a15694b4624a89bce4b49"});
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x23, 0x1A, 0x47};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x23, 0x20, 0x05};
